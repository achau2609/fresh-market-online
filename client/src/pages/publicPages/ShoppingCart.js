                    ...
                    <div className='row'>
                        ...
                        <div className='col-auto ps-0'>
                            <div className="btn-group" role="group">
                                <input type="radio" className="btn-check" name="btnradio" id="delivery-btn" autocomplete="off" />
                                <label className="btn btn-outline-custom-primary" for="delivery-btn">Delivery</label>

                                <input type="radio" className="btn-check" name="btnradio" id="pickup-btn" autocomplete="off" />
                                <label className="btn btn-outline-custom-primary" for="pickup-btn">Pickup</label>
                            </div>
                        </div>
                    </div>
                    <hr />
