            ...
            <div className='row'>
                ...
                <div className='col-6'>
                    ...
                    <div className='row row-cols-1 row-cols-md-4 justify-content-start gx-5'>
                        {product.Picture.map((source, index) =>
                            <div className='col m-2'>
                                <button type='button' className='btn p-0 m-0 position-relative' onClick={clickImage}>
                                    ...
                                    <button class="position-absolute top-0 start-100 translate-middle badge rounded-circle bg-danger border-0" onClick={()=> removeImage(index)}>
                        ...
                        {/* Upload image */}
                        <div className='col m-2'>
                            <label htmlFor='img-upload' className='card-img-top btn w-100 h-100 border-info rounded-top text-info pe-auto'>
                            ...
                            <input type="file" accept="image/*" className='btn form-control d-none' id='img-upload' name="img-upload" />
                        </div>
                    </div>
                    {/* Delete Button */}
                    <div className='row'>
                ...
                <div className='col-6'>
                    <form>
                        <div className='row mb-3 gx-0'>
                            ...
                            <input id='product-name' type='text' className='form-control' value={product.ProductName} />
                        </div>
                        <div className='row mb-3 gx-0'>
                            <label htmlFor='product-brand'>Brand</label>
                            <input id='product-brand' type='text' className='form-control' value='ABC' />
                        </div>
                        <div className='row mb-3 gx-0'>
                        ...
                        <div className='row mb-3 gx-0'>
                            ...
                            <textarea class="form-control" placeholder="Description" id="product-description" value={product.ProductDescription}></textarea>
                        </div>
                        <div className='row mb-3 gx-0'>
                            <label htmlFor='org-price'>Original Price</label>
                            <div className="input-group">
                                <span className="input-group-text">$</span>
                                <input type="text" className="form-control" id='org-price' onChange={changeOrgPrice} />
                            </div>
                        </div>
                        <div className='row mb-3 gx-0'>
                            <div className='col-auto col-md-4'>
                                <label htmlFor='product-inventory'>Inventory</label>
                                <input id='product-inventory' type='text' className='form-control' value='50' />
                            </div>
                        </div>
                        <div className='row mb-3 gx-0'>
                            <div className='col-7 form-check'>
                                <input className="form-check-input" type="checkbox" value="" id="discount" onChange={toggleHasDiscount} />
                        ...
                        <div className={hasDiscount ? 'row mb-3 gx-0' : 'd-none'}>
                            <div className='col-auto col-md-5 me-3'>
                                <div className="input-group">
                                    <span className="input-group-text">$</span>
                                    <input type="text" className="form-control" id='discount-number' value={discountNumber} onChange={changeDiscountNumber} />
                                </div>
                            </div>
                            <div className='col-auto col-md-5'>
                                <div className="input-group">
                                    <input type="text" className="form-control" id='discount-precentage' value={discountPercentage} onChange={changeDiscountPercentage} />
                                    <span className="input-group-text">%</span>
                                </div>
                            </div>
                        </div>
